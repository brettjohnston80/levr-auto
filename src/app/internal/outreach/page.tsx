...
import { getOutreachQueue, getFinalizationQueue } from "@/lib/outreach-queue";
...
export default async function OutreachQueuePage() {
  ...
  const [queue, finalizationQueue] = await Promise.all([getOutreachQueue(), getFinalizationQueue()]);
